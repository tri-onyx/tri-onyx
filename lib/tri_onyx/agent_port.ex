defmodule TriOnyx.AgentPort do
  ...
  @type event ::
          ...
          | {:social_post_request, String.t(), String.t()}
          | {:social_reply_request, String.t(), String.t()}
          | {:social_read_feed_request, String.t(), map()}
          | {:social_read_notifications_request, String.t(), map()}
          | {:social_read_dms_request, String.t(), map()}
          | {:social_schedule_post_request, String.t(), String.t()}
  ...
  @doc """
  Sends a `social_post_response` back to the runtime.
  """
  @spec send_social_post_response(GenServer.server(), String.t(), boolean(), String.t(), String.t()) ::
          :ok
  def send_social_post_response(server, request_id, success, detail \\ "", post_id \\ "") do
    GenServer.cast(
      server,
      {:send,
       %{
         "type" => "social_post_response",
         "request_id" => request_id,
         "success" => success,
         "detail" => detail,
         "post_id" => post_id
  ...
  @doc """
  Sends a `social_reply_response` back to the runtime.
  """
  @spec send_social_reply_response(GenServer.server(), String.t(), boolean(), String.t(), String.t()) ::
          :ok
  def send_social_reply_response(server, request_id, success, detail \\ "", reply_id \\ "") do
    GenServer.cast(
      server,
      {:send,
       %{
         "type" => "social_reply_response",
         "request_id" => request_id,
         "success" => success,
         "detail" => detail,
         "reply_id" => reply_id
  ...
  @doc """
  Sends a `social_read_feed_response` back to the runtime.
  """
  @spec send_social_read_feed_response(GenServer.server(), String.t(), boolean(), String.t(), [map()]) ::
          :ok
  def send_social_read_feed_response(server, request_id, success, detail \\ "", posts \\ []) do
    GenServer.cast(
      server,
      {:send,
       %{
         "type" => "social_read_feed_response",
         "request_id" => request_id,
         "success" => success,
         "detail" => detail,
         "posts" => posts
  ...
  @doc """
  Sends a `social_read_notifications_response` back to the runtime.
  """
  @spec send_social_read_notifications_response(
          GenServer.server(),
          String.t(),
          boolean(),
          String.t(),
  ...
  def send_social_read_notifications_response(
        server,
        request_id,
        success,
        detail \\ "",
    ...
    GenServer.cast(
      ...
      {:send,
       %{
         "type" => "social_read_notifications_response",
         "request_id" => request_id,
         "success" => success,
         "detail" => detail,
  ...
  @doc """
  Sends a `social_read_dms_response` back to the runtime.
  """
  @spec send_social_read_dms_response(GenServer.server(), String.t(), boolean(), String.t(), [map()]) ::
          :ok
  def send_social_read_dms_response(server, request_id, success, detail \\ "", messages \\ []) do
    GenServer.cast(
      server,
      {:send,
       %{
         "type" => "social_read_dms_response",
         "request_id" => request_id,
         "success" => success,
         "detail" => detail,
         "messages" => messages
  ...
  @doc """
  Sends a `social_schedule_post_response` back to the runtime.
  """
  @spec send_social_schedule_post_response(
          GenServer.server(),
          String.t(),
          boolean(),
          String.t(),
  ...
  def send_social_schedule_post_response(
        server,
        request_id,
        success,
        detail \\ "",
    ...
    GenServer.cast(
      ...
      {:send,
       %{
         "type" => "social_schedule_post_response",
         "request_id" => request_id,
         "success" => success,
         "detail" => detail,
  ...
  defp parse_event(json_line) do
    case Jason.decode(json_line) do
      ...
      when is_binary(req_id) and is_binary(draft_path) ->
        {:ok, {:social_post_request, req_id, draft_path}}
      ...
      when is_binary(req_id) and is_binary(draft_path) ->
        {:ok, {:social_reply_request, req_id, draft_path}}
      ...
      when is_binary(req_id) and is_map(params) ->
        {:ok, {:social_read_feed_request, req_id, params}}
      ...
      when is_binary(req_id) and is_map(params) ->
        {:ok, {:social_read_notifications_request, req_id, params}}
      ...
      when is_binary(req_id) and is_map(params) ->
        {:ok, {:social_read_dms_request, req_id, params}}
      ...
      when is_binary(req_id) and is_binary(draft_path) ->
        {:ok, {:social_schedule_post_request, req_id, draft_path}}
