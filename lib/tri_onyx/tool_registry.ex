defmodule TriOnyx.ToolRegistry do
  ...
  @tool_meta %{
    ...
    "SendEmail" => %{requires_auth: true, capability_level: :medium},
    "MoveEmail" => %{requires_auth: true, capability_level: :medium},
    "CreateFolder" => %{requires_auth: true, capability_level: :medium},
