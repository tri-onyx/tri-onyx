defmodule TriOnyx.Integration.TaintTest do
  ...
  Classification of individual tool results, inter-agent messages, the 2D
  risk matrix, and formatting are covered by the unit tests
  (information_classifier_test.exs, risk_scorer_test.exs).
  """
