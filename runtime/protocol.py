...
@dataclass
class SubmitItemResponse:
    """Response from the gateway after a submit_item_request."""
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> SubmitItemResponse:
        return cls(
            request_id=data.get("request_id", ""),
            success=data.get("success", False),
            detail=data.get("detail", ""),
...
def emit_submit_item_request(
    ...
    """Request the gateway to post an item to the connector."""
    _emit({
